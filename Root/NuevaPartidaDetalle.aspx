<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NuevaPartidaDetalle.aspx.cs" Inherits="Root.NuevaPartidaDetalle" %>
                        ...
                        <td colspan="2">
                            <asp:GridView ID="gvDocumentosDetalle" DataKeyNames="id" runat="server" CssClass="table" AllowPaging="false" PageSize="15" GridLines="None"  AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="No. Proveedor" DataField="no_proveedor" />
                                    <asp:BoundField HeaderText="Documento OC" DataField="documento_oc" />
                                    <asp:BoundField HeaderText="Tipo Procuración" DataField="tipo_procuracion" />
                            ...
                            <div class="modal-body p-0">
                                <table class="table table-sm table-borderless mt-0 mb-0">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtNoProveedor" runat="server" ClientIDMode="Static" CssClass="form-control numeric" MaxLength="6"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Documento OC:
                                            <asp:HiddenField ID="hdnNuevaPartidaId" runat="server" ClientIDMode="Static" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlTipoProcuracion" runat="server" ClientIDMode="Static" CssClass="form-control" AutoPostBack="false"></asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtTarget" runat="server" ClientIDMode="Static" CssClass="form-control numeric" autocomplete="off"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlUnidadMedida" runat="server" ClientIDMode="Static" CssClass="form-control" AutoPostBack="false"></asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
