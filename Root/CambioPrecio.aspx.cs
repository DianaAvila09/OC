...
namespace Root
{
    public partial class CambioPrecio : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                foreach (WfcpWorkflow wf in db.WfcpWorkflow.Where(x=>x.id == 1))
                {
        ...
        protected void load_registros(Int32 selectedIndex, Int32 editIndex, Int32 pageIndex)
        {
            try
            {
                ...
                gvDocumentos.DataSource = (from a in db.WfcpDocumento
                                           where a.WorkflowId == 1 && a.usuario == User.Identity.Name 
